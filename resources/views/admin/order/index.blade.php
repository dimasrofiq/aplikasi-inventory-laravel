                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <x-button-modal :id="$order->id" title="Tambahkan Permintaan" icon="plus" style="mr-1"
                            ...
                            <x-button-modal :id="$order->id" title="Edit" icon="edit" style="mr-1"
                                class="btn btn-info btn-sm" />
                            <x-modal :id="$order->id" title="Edit">
                                <form action="{{ route('admin.order.update', $order->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                            ...
                            <x-button-delete :id="$order->id" :url="route('admin.order.destroy', $order->id)" title="Delete"
