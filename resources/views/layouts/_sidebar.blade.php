<aside class="navbar navbar-vertical navbar-expand-lg bg-white">
    <div class="container">
        ...
        <a href="/" class="navbar-brand flex justify-center">
            <div class="flex flex-col items-center gap-2">
                <img class="h-6 ml-2 w-auto rounded-lg" src="{{ asset('logo-icon.png') }}" alt="Logo">
                <h3 class="text-center font-weight-bold">Warehouse</h3>
            </div>
        </a>
