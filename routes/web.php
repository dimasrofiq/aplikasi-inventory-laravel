...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth', 'role:Admin|Super Admin']], function () {
    ...
    Route::get('/billing-address/provinsi', [LocationController::class, 'getProvinsi']);
    Route::get('/billing-address/kota/{provinsi_id}', [LocationController::class, 'getKotaByProvinsi']);
    Route::get('/billing-address/kecamatan/{kota_id}', [LocationController::class, 'getKecamatanByKota']);
    Route::get('/billing-address/kelurahan/{kecamatan_id}', [LocationController::class, 'getKelurahanByKecamatan']);
});
